...
namespace DBAccessCoreDLL.Migrations
{
    ...
    [Migration("20210315093418_forum")]
    partial class forum
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DBAccessCoreDLL.EFORM.Entity.Forum.ForumModule", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("ForumModule");
                });

            modelBuilder.Entity("DBAccessCoreDLL.EFORM.Entity.Forum.ForumPost", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("DBAccessCoreDLL.EFORM.Entity.Forum.ForumReply", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("DBAccessCoreDLL.EFORM.Entity.Forum.ForumTopic", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("DBAccessCoreDLL.EFORM.Entity.Forum.ForumPost", b =>
                {
                    b.HasOne("DBAccessCoreDLL.EFORM.Entity.Forum.ForumTopic", "Topic")
                        .WithMany("Posts")
            ...
            modelBuilder.Entity("DBAccessCoreDLL.EFORM.Entity.Forum.ForumReply", b =>
                {
                    b.HasOne("DBAccessCoreDLL.EFORM.Entity.Forum.ForumPost", "Post")
                        .WithMany("Replies")
                        .HasForeignKey("PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DBAccessCoreDLL.EFORM.Entity.Forum.ForumReply", "Respondent")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("DBAccessCoreDLL.EFORM.Entity.Forum.ForumTopic", b =>
                {
                    b.HasOne("DBAccessCoreDLL.EFORM.Entity.Forum.ForumModule", "Module")
                        .WithMany("Topics")
